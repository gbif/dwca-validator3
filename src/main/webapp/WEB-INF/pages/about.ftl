...
<p>This validator was written by <a href="https://www.gbif.org">GBIF</a> to test Darwin Core Archives
as specified in the <a href="http://rs.tdwg.org/dwc/terms/guides/text/">Darwin Core Text Guide</a>.
Due to the simplicity of the archives GBIF originally encouraged publishers to create them using simple custom scripts.
Therefore the need arose to provide a testing framework for developers to make sure GBIF and others can read the information as expected.
 </p>

 <p>The validator uses the <a href="${cfg.metaSchemas[1]}">official XML schema</a> to validate the meta.xml descriptor,
 but additionally it uses the <a href="https://github.com/gbif/dwca-io">Darwin Core Archive I/O</a> Java library to validate the content against the known extensions and terms registered within the GBIF network for sharing biodiversity data.
...
<p>For more information please contact the <a mailto="helpdesk@gbif.org">GBIF Helpdesk</a>.</p>
